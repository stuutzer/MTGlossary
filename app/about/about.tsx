      ...
      <div className='center-b'>
        ...
        <div className='about-info'>
          <p className="about-info-a">
            <span className="regular">Inspired by <a  className="bold" href="https://glossary.infil.net/" target="_blank">Infil’s Fighting Game Glossary</a>, MTGlossary is an online glossary for Magic: The Gathering terms with multilingual functionality .</span>
            <br /><br />
